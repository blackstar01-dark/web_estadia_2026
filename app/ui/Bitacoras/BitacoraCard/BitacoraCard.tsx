...
export const BitacoraCard = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Glow sutil */}
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#0099CC]/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition" />
        ...
        {/* Content */}
        <h3 className="relative text-lg font-semibold text-[#1F2933] group-hover:text-[#0099CC] transition">
          {title}
        </h3>
        ...
        {/* Action */}
        <div
          className="relative mt-auto pt-6 flex items-center gap-2
