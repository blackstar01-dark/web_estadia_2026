...
import getBitacorasEstacion from "@/app/lib/bitacoras/findEstacion";
...
export const GetBitacorasEstacion = async ({
  estacionId,
  nombreEstacion,
}: Props) => {
  const bitacoras: Bitacora[] = await getBitacorasEstacion(estacionId);
    ...
    <section className="bg-white min-h-screen text-[#1F2933]">
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        {bitacoras.length === 0 ? (
          ...
          >
            No hay bitácoras registradas para esta estación.
          </div>
        ) : (
